...
FileWord::FileWord(const char *const file_name)
    : WordSource(), input_file(std::fopen(file_name, "r"))
{
...
static KeyboardAssociation keyboard_map[] = {
    ...
    KeyboardAssociation(0x07, "\"\x07\" add_text"), KeyboardAssociation(0x08, "backspace"),
    KeyboardAssociation(0x09, "tab"), KeyboardAssociation(0x0A, "delete_to_eol"),
    KeyboardAssociation(0x0B, "\"\x0B\" add_text"),
    KeyboardAssociation(0x0C, "\"\x0C\" add_text"), KeyboardAssociation(0x0D, "new_line"),
    ...
    KeyboardAssociation(0x1A, "\"\x1A\" add_text"), KeyboardAssociation(0x1B, "block_off"),
    ...
    KeyboardAssociation(0x7E, "\"\x7E\" add_text"), KeyboardAssociation(0x7F, "delete_to_sol"),
    ...
    KeyboardAssociation(scr::K_F1, "find_file"), KeyboardAssociation(scr::K_F2, "save_file"),
    KeyboardAssociation(scr::K_F3, "next_file"), KeyboardAssociation(scr::K_F4, "remove_file"),
    KeyboardAssociation(scr::K_F5, "toggle_block"), KeyboardAssociation(scr::K_F6, "cut"),
    KeyboardAssociation(scr::K_F7, "paste"), KeyboardAssociation(scr::K_F8, "insert_file"),
    KeyboardAssociation(scr::K_F9, "goto_line"),
    KeyboardAssociation(scr::K_F10, "external_command"),
    KeyboardAssociation(scr::K_SF1, "help"), KeyboardAssociation(scr::K_SF2, "editor_info"),
    ...
    KeyboardAssociation(scr::K_CF5, "set_mark"), KeyboardAssociation(scr::K_CF6, "toggle_mark"),
    ...
    KeyboardAssociation(scr::K_END, "end_of_line"), KeyboardAssociation(scr::K_PGUP, "page_up"),
    ...
    KeyboardAssociation(scr::K_DEL, "delete"), KeyboardAssociation(scr::K_CHOME, "top_of_file"),
    ...
    KeyboardAssociation(scr::K_ALTX, "exit"), KeyboardAssociation(scr::K_ALTY, "yexit"),
...
static const char *const key_names[] = {
    "K_NULL",       "K_CTRLA",     "K_CTRLB", "K_CTRLC",  "K_CTRLD", "K_CTRLE",   "K_CTRLF",
    "K_CTRLG",      "K_BACKSPACE", "K_TAB",   "K_CTRLJ",  "K_CTRLK", "K_CTRLL",   "K_RETURN",
    "K_CTRLN",      "K_CTRLO",     "K_CTRLP", "K_CTRLQ",  "K_CTRLR", "K_CTRLS",   "K_CTRLT",
    "K_CTRLU",      "K_CTRLV",     "K_CTRLW", "K_CTRLX",  "K_CTRLY", "K_CTRLZ",   "K_ESC",
    "K_CTRL\\",     "K_CTRL`",     "K_CTRL=", "K_CTRL-",  "K_SPACE", "K_!",       "K_\"",
    "K_#",          "K_$",         "K_%",     "K_&",      "K_'",     "K_(",       "K_)",
    "K_*",          "K_+",         "K_,",     "K_-",      "K_.",     "K_/",       "K_0",
    "K_1",          "K_2",         "K_3",     "K_4",      "K_5",     "K_6",       "K_7",
    "K_8",          "K_9",         "K_0",     "K_:",      "K_;",     "K_<",       "K_>",
    "K_?",          "K_@",         "K_A",     "K_B",      "K_C",     "K_D",       "K_E",
    "K_F",          "K_G",         "K_H",     "K_I",      "K_J",     "K_K",       "K_L",
    "K_M",          "K_N",         "K_O",     "K_P",      "K_Q",     "K_R",       "K_S",
    "K_T",          "K_U",         "K_V",     "K_W",      "K_X",     "K_Y",       "K_Z",
    "K_[",          "K_\\",        "K_]",     "K_^",      "K__",     "K_`",       "K_a",
    "K_b",          "K_c",         "K_d",     "K_e",      "K_f",     "K_g",       "K_h",
    "K_i",          "K_j",         "K_k",     "K_l",      "K_m",     "K_n",       "K_o",
    "K_p",          "K_q",         "K_r",     "K_s",      "K_t",     "K_u",       "K_v",
    "K_w",          "K_x",         "K_y",     "K_z",      "K_{",     "K_|",       "K_}",
    "K_~",          "K_CRETURN",   "K_128",   "K_129",    "K_130",   "K_131",     "K_132",
    "K_133",        "K_134",       "K_135",   "K_136",    "K_137",   "K_138",     "K_139",
    "K_140",        "K_141",       "K_142",   "K_143",    "K_144",   "K_145",     "K_146",
    "K_147",        "K_148",       "K_149",   "K_150",    "K_151",   "K_152",     "K_153",
    "K_154",        "K_155",       "K_156",   "K_157",    "K_158",   "K_159",     "K_160",
    "K_161",        "K_162",       "K_163",   "K_164",    "K_165",   "K_166",     "K_167",
    "K_168",        "K_169",       "K_170",   "K_171",    "K_172",   "K_173",     "K_174",
    "K_175",        "K_176",       "K_177",   "K_178",    "K_179",   "K_180",     "K_181",
    "K_182",        "K_183",       "K_184",   "K_185",    "K_186",   "K_187",     "K_188",
    "K_189",        "K_190",       "K_191",   "K_192",    "K_193",   "K_194",     "K_195",
    "K_196",        "K_197",       "K_198",   "K_199",    "K_200",   "K_201",     "K_202",
    "K_203",        "K_204",       "K_205",   "K_206",    "K_207",   "K_208",     "K_209",
    "K_210",        "K_211",       "K_212",   "K_213",    "K_214",   "K_215",     "K_216",
    "K_217",        "K_218",       "K_219",   "K_220",    "K_221",   "K_222",     "K_223",
    "K_224",        "K_225",       "K_226",   "K_227",    "K_228",   "K_229",     "K_230",
    "K_231",        "K_232",       "K_233",   "K_234",    "K_235",   "K_236",     "K_237",
    "K_238",        "K_239",       "K_240",   "K_241",    "K_242",   "K_243",     "K_244",
    "K_245",        "K_246",       "K_247",   "K_248",    "K_249",   "K_250",     "K_251",
    "K_252",        "K_253",       "K_254",   "K_255",    "K_F1",    "K_F2",      "K_F3",
    "K_F4",         "K_F5",        "K_F6",    "K_F7",     "K_F8",    "K_F9",      "K_F10",
    "K_SF1",        "K_SF2",       "K_SF3",   "K_SF4",    "K_SF5",   "K_SF6",     "K_SF7",
    "K_SF8",        "K_SF9",       "K_SF10",  "K_CF1",    "K_CF2",   "K_CF3",     "K_CF4",
    "K_CF5",        "K_CF6",       "K_CF7",   "K_CF8",    "K_CF9",   "K_CF10",    "K_AF1",
    "K_AF2",        "K_AF3",       "K_AF4",   "K_AF5",    "K_AF6",   "K_AF7",     "K_AF8",
    "K_AF9",        "K_AF10",      "K_HOME",  "K_END",    "K_PGUP",  "K_PGDN",    "K_LEFT",
    "K_RIGHT",      "K_UP",        "K_DOWN",  "K_INS",    "K_DEL",   "K_CHOME",   "K_CEND",
    "K_CPGUP",      "K_CPGDN",     "K_CLEFT", "K_CRIGHT", "K_ALTA",  "K_ALTB",    "K_ALTC",
    "K_ALTD",       "K_ALTE",      "K_ALTF",  "K_ALTG",   "K_ALTH",  "K_ALTI",    "K_ALTJ",
    "K_ALTK",       "K_ALTL",      "K_ALTM",  "K_ALTN",   "K_ALTO",  "K_ALTP",    "K_ALTQ",
    "K_ALTR",       "K_ALTS",      "K_ALTT",  "K_ALTU",   "K_ALTV",  "K_ALTW",    "K_ALTX",
    "K_ALTY",       "K_ALTZ",      "K_ALT1",  "K_ALT2",   "K_ALT3",  "K_ALT4",    "K_ALT5",
    "K_ALT6",       "K_ALT7",      "K_ALT8",  "K_ALT9",   "K_ALT0",  "K_ALTDASH", "K_ALTEQU",
    "K_CTRL_PRTSC", nullptr};
...
void modify_key_association(const char *const key_name, const char *const new_macro_text)
{
    ...
    for (index = 0; key_names[index] != nullptr; index++)
        if (std::strcmp(key_name, key_names[index]) == 0)
            break;
